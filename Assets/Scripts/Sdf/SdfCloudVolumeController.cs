...
public class SdfCloudVolumeController : MonoBehaviour
{
    ...
    [SerializeField] [Range(0.0f, 1.0f)] private float coverage = 0.62f;
    [SerializeField] [Range(0.01f, 1.0f)] private float softness = 0.2f;
    [SerializeField] [Range(0.0f, 1.0f)] private float detailStrength = 0.52f;
    ...
    [SerializeField] [Range(0.0f, 4.0f)] private float densityBoost = 1.75f;

    [Header("Cloud Medium")]
    [SerializeField] [Range(0.0f, 8.0f)] private float lightIntensity = 4.8f;
    [SerializeField] [Range(0.0f, 8.0f)] private float lightDensity = 1.35f;
    [SerializeField] [Range(0.0f, 0.08f)] private float baseFogDensity = 0.001f;
    [SerializeField] [Range(0.0f, 0.5f)] private float heightFogStrength = 0.04f;
    [SerializeField] [Range(0.0f, 4.0f)] private float cutFogBoost = 1.15f;
    [SerializeField] [Range(0.0f, 8.0f)] private float absorptionDensity = 0.2f;
    [SerializeField] [Range(0.0f, 0.2f)] private float densityThreshold = 0.012f;
    [SerializeField] [Range(0.0f, 0.05f)] private float alphaClipThreshold = 0.006f;
    [SerializeField] [Range(0.1f, 4.0f)] private float exposure = 1.55f;
    [SerializeField] private Color colorTint = new Color(1.0f, 0.78f, 0.56f, 1.0f);
    [SerializeField] [Range(0.0f, 4.0f)] private float emissionIntensity = 0.08f;
    ...
    [SerializeField] [Range(0.0f, 64.0f)] private float warmCoreIntensity = 28.0f;
    [SerializeField] [Min(0.05f)] private float warmCoreRange = 5.8f;
    ...
    private void ApplySoftProfile()
    {
        ...
        lightIntensity = 3.6f;
        lightDensity = 1.05f;
        baseFogDensity = 0.0012f;
        heightFogStrength = 0.04f;
        cutFogBoost = 1.0f;
        absorptionDensity = 0.14f;
        densityThreshold = 0.01f;
        alphaClipThreshold = 0.005f;
        exposure = 1.35f;
        colorTint = new Color(1.0f, 0.84f, 0.68f, 1.0f);
        emissionIntensity = 0.02f;
    ...
    private void ApplyExplosionProfile()
    {
        ...
        lightIntensity = 4.8f;
        lightDensity = 1.35f;
        baseFogDensity = 0.001f;
        heightFogStrength = 0.04f;
        cutFogBoost = 1.15f;
        absorptionDensity = 0.2f;
        densityThreshold = 0.012f;
        alphaClipThreshold = 0.006f;
        exposure = 1.55f;
        colorTint = new Color(1.0f, 0.78f, 0.56f, 1.0f);
        emissionIntensity = 0.08f;
        emissionColor = new Color(1.0f, 0.62f, 0.22f, 1.0f);
        warmCoreIntensity = 28.0f;
        warmCoreRange = 5.8f;
    }
    ...
    private void ApplyCutDustProfile()
    {
        ...
        lightIntensity = 3.2f;
        lightDensity = 1.2f;
        baseFogDensity = 0.0008f;
        heightFogStrength = 0.025f;
        cutFogBoost = 1.85f;
        absorptionDensity = 0.18f;
        densityThreshold = 0.014f;
        alphaClipThreshold = 0.007f;
        exposure = 1.35f;
        colorTint = new Color(1.0f, 0.78f, 0.62f, 1.0f);
        emissionIntensity = 0.03f;
        emissionColor = new Color(1.0f, 0.58f, 0.22f, 1.0f);
        warmCoreIntensity = 20.0f;
        warmCoreRange = 5.2f;
    }
